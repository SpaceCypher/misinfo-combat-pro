...
import { 
  ...
  Calendar, Users, Zap, Eye, FileText, AlertTriangle
} from 'lucide-react';
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
                      ...
                      <div className="mb-4">
                        ...
                        <p className="text-xs text-gray-500 mt-1">Intermediate Analysis - Lesson 9/12</p>
                      </div>
                      <button className="w-full bg-gray-900 text-white py-2 rounded-lg font-medium hover:bg-gray-800 transition-colors">
                        Continue Training
                      </button>
                    ...
                    <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
                      ...
                      <input
                        ...
                        className="w-full p-3 border border-gray-300 rounded-lg mb-4 text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                      />
                      <button className="w-full bg-gray-900 text-white py-2 rounded-lg font-medium hover:bg-gray-800 transition-colors">
                        Verify Claims
                      </button>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    ...
                    <div className="bg-white p-6 rounded-lg border border-gray-200 text-center">
                      ...
                      <div className="text-xs text-green-600">+3% improved</div>
                    </div>
                    <div className="bg-white p-6 rounded-lg border border-gray-200 text-center">
                    ...
                    <div className="bg-white p-6 rounded-lg border border-gray-200 text-center">
                      ...
                      <div className="text-xs text-gray-600">850/1000 XP</div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-white rounded-lg border border-gray-200 divide-y divide-gray-200">
                    <div className="p-4 flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-900">Analyzed news article about election claims</p>
                          <p className="text-sm text-gray-600">2 hours ago • High risk detected (78%)</p>
                        </div>
                      </div>
                      <span className="px-2 py-1 bg-red-100 text-red-800 text-xs font-medium rounded">78% Risk</span>
                    </div>
                    <div className="p-4 flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-900">Completed lesson: Identifying deepfake videos</p>
                          <p className="text-sm text-gray-600">5 hours ago • Scored 92%</p>
                        </div>
                      </div>
                      <span className="px-2 py-1 bg-green-100 text-green-800 text-xs font-medium rounded">+50 XP</span>
                    </div>
                    <div className="p-4 flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-900">Verified claims in WhatsApp forward</p>
                          <p className="text-sm text-gray-600">Yesterday • 3 false claims identified</p>
                        </div>
                      </div>
                      <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded">Verified</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  <h2 className="text-xl font-semibold text-gray-900 mb-4">Today's Misinformation Tip</h2>
