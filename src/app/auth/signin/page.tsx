        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={loading}
              className="mt-4 w-full bg-white hover:bg-gray-50 border border-gray-300 text-gray-700 font-semibold py-3 px-4 rounded-lg transition-colors flex items-center justify-center space-x-2"
            >
